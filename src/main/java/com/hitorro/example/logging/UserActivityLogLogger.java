 ...
 *
 * DO NOT EDIT - This file is auto-generated from the log config using generate_loggers.py
 */
@Component
...
public class UserActivityLogLogger extends BaseStructuredLogger {
    ...
    /**
     * Log a simpler event with just the essential fields.
     */
    public void logLogin(String userId, String username, String ipAddress, String userAgent) {
        LocalDate today = LocalDate.now();
        log(userId, username, "LOGIN", today, Instant.now(), ipAddress, userAgent, null, null, null, null, null, null);
    }
    ...
    public void logLogout(String userId, String username, String sessionId) {
        LocalDate today = LocalDate.now();
        log(userId, username, "LOGOUT", today, Instant.now(), null, null, null, null, null, null, sessionId, null);
    }

    /**
     * Log an API access event.
     */
    public void logApiAccess(String userId, String endpoint, String httpMethod, int statusCode, Long responseTimeMs) {
        LocalDate today = LocalDate.now();
        log(userId, null, "API_ACCESS", today, Instant.now(), null, null, endpoint, httpMethod, statusCode, responseTimeMs, null, null);
    }
